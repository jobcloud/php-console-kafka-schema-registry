...
EOF;
    ...
    public function testCommandSuccess(): void {
        ...
        $command = $application->find('kafka-schema-registry:check:doc:comments');
        ...
        self::assertStringContainsString('Schema has doc comments on all fields', $commandOutput);
    ...
    public function testCommandBadSchema(): void {
        ...
        self::assertStringContainsString('Schema does not have doc comments on all fields', $commandOutput);
